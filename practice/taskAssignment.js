...
format: [task1, task2], where the order of task1 and task2 doesn't matter.
Your function can return the pairs in any order. If mutiple optimal assignments exist, 
any correct answer will be accepted.

Note: you'll always be given at least one worker // k will always be greater than 0
...
// there are multiple correct answers for this input. something like:

[
  [2, 4],  // tasks[2] =  5, tasks[4] = 1 | 1 + 5 = 6
